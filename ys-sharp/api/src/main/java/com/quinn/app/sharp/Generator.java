...
// 代码生成器
        ...
        dsc.setPassword("Sharp123456@");
        mpg.setDataSource(dsc);

        // 包配置
        PackageConfig pc = new PackageConfig();
        pc.setModuleName("sharp");
        pc.setParent("com.quinn.app");
        pc.setXml("dsf");
        ...
        */
        ...
        strategy.setSuperEntityClass("com.quinn.app.sharp.entity.BaseEntity");
        strategy.setEntityLombokModel(true);
        strategy.setRestControllerStyle(true);
        // 公共父类
        strategy.setSuperControllerClass("com.quinn.app.sharp.controller.BaseController");
        // 写于父类中的公共字段
